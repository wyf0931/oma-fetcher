...
async def fetch_page(payload: FetchRequest):
    ...
    try:
        ...
        return envelope(0, "ok", extracted, {"final_url": result.final_url, "strategy": result.strategy, "status_code": result.status_code, "content_type": result.content_type, "attempts": attempts, "proxy_enabled": settings.proxy_enabled, "page": page_metadata or {}})
